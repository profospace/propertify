...
app.post('/api/upload/property',upload.fields([{ name: 'post_image', maxCount: 1 }, 
 ...
 { name: 'floor_plan_image', maxCount: 1 },{ name: 'galleryList', maxCount: 10 }]),async (req, res) => {
  ...
  try {
    ...
    console.log('Files received: printing path', req.files['post_image'].path);
    console.log('Files received: destination', req.files['post_image'].path);

    console.log('Files received:', req.files['post_image'].stringify);



    console.log('Files received:1 =========', req.files[0]);

    console.log('Files received: 2 =========', req.files[0].stringify);
