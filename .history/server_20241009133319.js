...
app.get('/api/properties/filter', async (req, res) => {
  ...
  try {
    ...
    if (latitude && longitude) {
      ...
      console.log(`Added geospatial filter: lat ${latitude}, lon ${longitude}, radius ${radiusInMeters}m`);
    }
    ...
    if (sort) {
      ...
      console.log(`Sorting by ${field} in ${order === 'desc' ? 'descending' : 'ascending'} order`);
    }
