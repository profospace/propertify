...
app.get('/api/home-feed', async (req, res) => {
  try {
    ...
    const apartments = await getNearbyProperties('Apartments');
    ...
    const homeFeed = [
      {
        ...
        title: 'Free delivery & Guaranteed coupons!',
        subtitle: 'from restaurants in POCKET HERO',
        backgroundColor: '#8A2BE2', // Purple
        buttonText: 'Try Pocket Hero',
        buttonLink: 'https://example.com/pocket-hero',
      ...
      },
      {
        ...
        buttonColor: '#8E4585', // Dark Orchid
