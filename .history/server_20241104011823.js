  ...
  try {
    ...
    const homeFeed = [
      ...
      })),
      {
        ...
        buttonColor: '#ff6b6b',
        projects: projects
          .filter(project => project.status === 'UNDER_CONSTRUCTION')
          .map(project => ({
            ...
            image: project.images?.[0] || 'https://example.com/default-project.jpg',
            ...
            overview: {
              startingPrice: project.overview?.priceRange?.min || 0,
              possession: project.overview?.possessionDate || 'Coming Soon'
            }
          })),
        viewType: 'compact'
      },
