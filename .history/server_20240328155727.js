...
app.get('/api/update_gallery_list', async (req, res) => {
  try {
    ...
    // Modify each property object to rename galleryList key to gallery_list
    const updatedProperties = allProperties.map(property => {
      const updatedProperty = { ...property._doc };
      updatedProperty.gallery_list = updatedProperty.galleryList;
      delete updatedProperty.galleryList;
      return updatedProperty;
    });

    // Respond with the updated properties
